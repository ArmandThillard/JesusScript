...
export class ConsultationComponent implements OnInit {
  ...
  onAppointmentSubmit(): Appointment {
    ...
    appointment.minutesDuration = this.msToMinutes(
    ...
    var participant = [];
    var patientActor = new Actor(
      'Patient/612e0350a5b46400122dx508',
      'Jesus SCRIPT'
    );
    var patient = new Participant(patientActor, 'required', 'accepted');
    var medActor = new Actor(
      'Practitioner/613f4b25a5b46400122cf50f',
      'Dr MARTIN Pierre'
    );
